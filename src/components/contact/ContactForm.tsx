  ...
  if (status === 'success') {
    return (
      ...
      >
        ...
        <button onClick={() => setStatus('idle')} className="liquid-btn liquid-btn-secondary">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                'liquid-input pl-12',
                errors.email ? 'border-red-500/30' : ''
              )}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              'liquid-input pl-12',
              errors.subject ? 'border-red-500/30' : ''
            )}
      ...
      <div>
        ...
        <div className="relative">
          ...
          <textarea
            ...
            {...register('message')}
            className={cn(
              'liquid-input pl-12 resize-none',
              errors.message ? 'border-red-500/30' : ''
            )}
